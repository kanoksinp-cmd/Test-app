...
# รายชื่อธนาคารหลักสำหรับให้เลือก
BANK_LIST = [
    "-- เลือกธนาคาร --",
    "กสิกรไทย (KBank)",
    "ไทยพาณิชย์ (SCB)",
...
with st.sidebar.expander("👤 ลงทะเบียน / แก้ไขข้อมูลสมาชิก"):
    ...
    if user_mode == "ลงทะเบียนใหม่":
        ...
        if existing_all_users:
            ...
            # กำหนดค่าเริ่มต้นของ Selectbox ธนาคารเดิม
...
with tab3:
    ...
    # ดึงประวัติข้อมูลธนาคารและพร้อมเพย์ของสมาชิกทุกคน
    ...
    if not expenses_rows: st.info("ยังไม่มีข้อมูล")
        ...
        while debtors and creditors:
            ...
            # ดึงข้อมูลบัญชีผู้รับเงินปลายทาง (Creditor)
