            ...
            if st.button("อัปเดตข้อมูลบัญชี"):
                if not edit_name:
                    ...
                    try:
                        ...
                        # หากเปลี่ยนชื่อ ให้ตามไปอัปเดตตารางอื่นที่เก็บค่าแบบ Text Name ด้วย
...
st.sidebar.markdown("---")
new_trip_name = st.sidebar.text_input("➕ สร้าง Event ใหม่:").strip()
...
# --- แสดงรายชื่อสมาชิกปัจจุบัน + ปุ่มถอดสมาชิก ---
if existing_members:
